 ...
 *
 **/
public class CornellScene extends Scene<RGBColor> {
	...
	public CornellScene() {
		...
		this.shapes.add(Sphere.create(new Vector3(- 2.5, - 2.0,   1.3), 1.3, RGBMaterial.GLASS));
	}
